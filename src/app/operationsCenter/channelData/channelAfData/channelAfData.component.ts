...
@Component({
  selector : "" ,
  templateUrl : "./channelAfData.component.html" ,
  styleUrls : ['./channelAfData.component.less']
})
export class ChannelAfDataComponent implements OnInit{
  ...
  downloadAFList(){
    ...
    this.service.downloadAFList(this.searchModel);
  }
}
