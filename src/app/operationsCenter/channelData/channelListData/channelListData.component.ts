...
@Component({
  selector : "" ,
  templateUrl : "./channelListData.component.html" ,
  styleUrls : ['./channelListData.component.less']
})
export class ChannelListDataComponent implements OnInit{
  ...
  initialTable(){
    this.tableData = {
      ...
      tableTitle : [
        ...
        {
          name : __this.languagePack['list']['channelBranchName'] ,
          reflect : "channelBranchName" ,
          type : "text"
        },
        {
          name : __this.languagePack['list']['invitationCode'] ,
        ...
        {
          name : __this.languagePack['list']['firstLoanLoanNumber'] ,
  ...
  getList(){
    ...
    this.service.getChannelList(data)
      .pipe(
        filter( (res : Response) => {
  ...
  downloadChannelList(){
    ...
    this.service.downloadChannelList(this.searchModel);
  };
}
