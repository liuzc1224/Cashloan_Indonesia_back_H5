...
@Component({
  selector : "" ,
  templateUrl : "./channelH5Data.component.html" ,
  styleUrls : ['./channelH5Data.component.less']
})
export class ChannelH5DataComponent implements OnInit{
  ...
  initialTable(){
    this.tableData = {
      ...
      tableTitle : [
        ...
        {
          name : __this.languagePack['list']['channelLink'] ,
          reflect : "link" ,
          type : "text"
        },
        {
  ...
  downloadH5PageNameList(){
    ...
    this.service.downloadH5PageNameList(this.searchModel);
  };
}
